...
import { setChoseNewEmail, setChoseNewWorkEmail, setChosePersonalEmail, setChoseVirtual, setFoundPersonalEmail, setGotMimAttackEmail, setSecuredCommunications, setSecurePassword, setUsedWorkEmail } from '../localStorageHelpers';
...
export const Navbar = () => {
  ...
  const handleRestart = () => {
    ...
    setUsedWorkEmail(false);
    setGotMimAttackEmail(false);
    setChoseVirtual(false);
    setChosePersonalEmail(false);
    setChoseNewEmail(false);
    setChoseNewWorkEmail(false);
    setSecurePassword(false);
    setSecuredCommunications(false);
    navigate("/");
