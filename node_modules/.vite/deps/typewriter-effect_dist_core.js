...
var require_core = __commonJS({
  "node_modules/typewriter-effect/dist/core.js"(exports, module) {
    !function(e, t) {
      ...
      var e = { 3146: (e2, t2, n2) => {
        for (var r2 = n2(3491), o = "undefined" == typeof window ? n2.g : window, a = ["moz", "webkit"], i = "AnimationFrame", s = o["request" + i], u = o["cancel" + i] || o["cancelRequest" + i], l = 0; !s && l < a.length; l++) s = o[a[l] + "Request" + i], u = o[a[l] + "Cancel" + i] || o[a[l] + "CancelRequest" + i];
        if (!s || !u) {
              ...
              if (E2.state.eventLoop = t2()(E2.runEventLoop), !E2.state.eventLoopPaused) {
                ...
                if (!(n3 <= (r4 = g4.eventName === l || g4.eventName === s ? "natural" === E2.options.deleteSpeed ? a(40, 80) : E2.options.deleteSpeed : "natural" === E2.options.delay ? a(120, 160) : E2.options.delay))) {
                  ...
                  switch (E2.logInDevMode({ currentEvent: g4, state: E2.state, delay: r4 }), T3) {
                    case m:
                    case i:
                      var S2 = A2.character, N2 = A2.node, C2 = document.createTextNode(S2), _ = C2;
                      E2.options.onCreateTextNode && "function" == typeof E2.options.onCreateTextNode && (_ = E2.options.onCreateTextNode(S2, C2)), _ && (N2 ? N2.appendChild(_) : E2.state.elements.wrapper.appendChild(_)), E2.state.visibleNodes = [].concat(b(E2.state.visibleNodes), [{ type: "TEXT_NODE", character: S2, node: _ }]);
                      break;
                    case s:
                    ...
                    case d:
                      ...
                      break;
                    case u:
                      var R = E2.state.visibleNodes, k = A2.speed, Q = [];
